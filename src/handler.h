...
bool	affected_by_spell(struct char_data *ch, int num, byte type);
...
// Moves ranged combat/spell victims into room with shooter/caster
// called from spell_parser and fight.c
void mob_reaction(struct char_data *ch, struct char_data *victim);
// determines if quickdraw is real combat or just fun
...
void	damage(struct char_data *, struct char_data *, int, int, int);
int	skill_message(int dam, struct char_data *ch, struct char_data *vict,
		      int attacktype, int abil_type);
void    autosplit(struct char_data *ch);
