...
void fry_victim(struct char_data * ch)
{
  ...
  case 7:
    ...
    cast_spell(ch, tch, 0, SPELL_FIREBALL, ABT_SPELL, FALSE);
    break;
  default:
    if (!number(0, 1))
      cast_spell(ch, ch, 0, SPELL_HEAL, ABT_SPELL, FALSE);
    break;
  }
