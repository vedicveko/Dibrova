...
#define IS_GOD(ch)		(!IS_NPC(ch) && (GET_LEVEL(ch) > LVL_ADMIN))
...
#define TRADE_NOSORCERER	(1 << 3)
#define TRADE_NOCLERIC		(1 << 4)
#define TRADE_NOTHIEF		(1 << 5)
#define TRADE_NOGLADIATOR       (1 << 6)
#define TRADE_NODRUID           (1 << 7)
#define TRADE_NODARK_KNIGHT     (1 << 8)
#define TRADE_NOMONK            (1 << 9)
#define TRADE_NOPALADIN         (1 << 10)
#define TRADE_NODWARF           (1 << 11)
#define TRADE_NOELDAR           (1 << 12)
#define TRADE_NOELF             (1 << 13)
#define TRADE_NOGIANT           (1 << 14)
#define TRADE_NOHALFLING        (1 << 15)
#define TRADE_NOHUMAN           (1 << 16)
#define TRADE_NOKENDER          (1 << 17)
#define TRADE_NOOGRE            (1 << 18)
#define TRADE_NOTRITON          (1 << 19)
#define TRADE_NOVALKYRIE        (1 << 20)
#define TRADE_NOWOLFEN          (1 << 21)
#define TRADE_NOBARD            (1 << 22)
...
#define NOTRADE_GLADIATOR(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOGLADIATOR))
#define NOTRADE_DRUID(i)        (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NODRUID))
#define NOTRADE_DARK_KNIGHT(i) (IS_SET(SHOP_TRADE_WITH((i)),TRADE_NODARK_KNIGHT))
...
#define NOTRADE_ELDAR(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOELDAR))
...
#define NOTRADE_OGRE(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOOGRE))
#define NOTRADE_TRITON(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOTRITON))
#define NOTRADE_VALKYRIE(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOVALKYRIE))
#define NOTRADE_WOLFEN(i)   (IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOWOLFEN))
