...
struct board_info_type board_info[NUM_OF_BOARDS] = {
  {3099, 0, 0, LVL_ADMIN, "etc/board.mort", 0},
  {3098, LVL_IMMORT, LVL_IMMORT, LVL_BUILDER, "etc/board.immort", 0},
  {3097, LVL_IMMORT, LVL_FREEZE, LVL_IMPL, "etc/board.freeze", 0},
  {3096, 0, 0, LVL_IMMORT, "etc/board.social", 0},
  {1205, LVL_IMMORT, LVL_IMMORT, LVL_BUILDER_H, "etc/board.builder", 0},
  {1226, LVL_IMMORT, LVL_IMMORT, LVL_CODER, "etc/board.coder", 0},
  {3026, 0, 0, LVL_IMMORT, "etc/board.sugg", 0},
  {3082, 0, 0, LVL_QUESTOR, "etc/board.quest", 0},
  {3093, 0, 0, LVL_IMMORT, "etc/board.sor", 0},
  {3095, 0, 0, LVL_IMMORT, "etc/board.thi", 0},
  {3092, 0, 0, LVL_IMMORT, "etc/board.cle", 0},
  {3094, 0, 0, LVL_IMMORT, "etc/board.gla", 0},
  {3089, 0, 0, LVL_IMMORT, "etc/board.ran", 0},
  {3090, 0, 0, LVL_IMMORT, "etc/board.dkn", 0},
  {3091, 0, 0, LVL_IMMORT, "etc/board.mon", 0},
  {3088, 0, 0, LVL_IMMORT, "etc/board.pal", 0},
  {3087, 0, 0, LVL_IMMORT, "etc/board.adder", 0},
  {30100,0, 0, LVL_IMMORT, "etc/board.khatir", 0},
  {30300,0, 0, LVL_IMMORT, "etc/board.seven", 0},
  {30201,0, 0, LVL_IMMORT, "etc/board.salliance", 0},
  {1271, 0, 0, LVL_IMMORT, "etc/board.clan", 0},
  {30400,0, 0, LVL_IMMORT, "etc/board.pahlawan", 0},
  {30500,0, 0, LVL_IMMORT, "etc/board.HED", 0},
  {30600,0, 0, LVL_IMMORT, "etc/board.lostsouls", 0},
  {30700, 0, 0, LVL_IMMORT, "etc/board.blackhand", 0},
  {3084, 1, 155, 155, "etc/board.changes", 0},
  {1291, 155, 155, 155, "etc/board.delilmanduil", 0},
  {1292, 155, 155, 158, "etc/board.raiker", 0},
};
...
int Board_display_msg(int board_type, struct char_data * ch, char *arg)
{
  ...
  sprintf(buf, "$n reads message number %d.\r\n", ind+1);
